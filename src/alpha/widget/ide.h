...
#ifndef __ALPHA_IDE_H__
#define __ALPHA_IDE_H__
...
struct ide : public Wt::WApplication {
	ide(const Wt::WEnvironment& env);
...
private:
	...
	void log(std::string message) { ide::log("info", message); }
